/*******************************************************************************
 * Name: QuizziPedia::Front-End::Controllers::QuestionsManagementController_test;
 ...
 * Updates history
 * -------------------------------------------------------------------------------
 * ID: QuestionsManagementController_test_20160526;
 * Update data: 02-06-2016;
 * Description: Creazione controller
 * Author: Franco Berton.
 *-------------------------------------------------------------------------------
 *******************************************************************************/


describe('Testing QuestionsManagementController', function () {
    var $scope;
    var $q;
    var deferred;
    var $rootScope;
